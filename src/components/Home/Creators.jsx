            ...
            <div className="w-full flex flex-wrap justify-between mt-6">
                {
                    creators.map((creator) => (
                        <div key={creator.id} className="w-[24%] flex flex-col gap-y-3 justify-center items-center h-[240px] bg-[#3b3b3b] mb-4 rounded-2xl">
                            <img src={creator.avatar} alt="..." className='w-[130px] h-[130px] rounded-full object-cover' />
